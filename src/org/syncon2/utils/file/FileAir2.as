package  org.syncon2.utils.file
{
	...
	public class FileAir2  
	{
		...
		public function downloadFileTo(url : String, dir : String, filename:String, fx : Function=null , rename_if_used : Boolean = false):void
		{
			var pss :   SendRequest = new SendRequest(); 
			var params : Object = {}; 
			params.file = filename
		...
		{
			trace('upload onDeleteFileFault'); 
		...
		*/
		...
		private function randomize(params:Object):void
		{
